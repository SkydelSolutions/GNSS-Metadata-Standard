...
namespace GnssMetadata
{
	...
	public:
		File( const IonString& id = "", bool bIsReference = false)
		...
		IonString Owner( ) const
		{
			return _owner;
		}
		void Owner( const IonString& owner )
		{
			_owner = owner;
		}

		IonString Copyright( ) const
		{
			return _copyright;
		}
		void Copyright( const IonString& copyright )
		{
