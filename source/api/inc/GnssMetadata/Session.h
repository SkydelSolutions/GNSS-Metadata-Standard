...
namespace GnssMetadata
{
	...
	public:
		...
		IonString Campaign( ) const
		{
			return _campaign;
		}
		void Campaign( const IonString& campaign )
		{
			_campaign = campaign;
		}
		IonString Contact( ) const
		{
			return _contact;
		}
		void Contact( const IonString& contact )
		{
			_contact = contact;
		}
		...
		void Poc( const IonString& poc )
		{
			_poc = poc;
		}
		
		void Scenario( const IonString& scenario )
		{
			_scenario = scenario;
		}
		IonString Scenario( ) const
		{
			return _scenario;
		}
